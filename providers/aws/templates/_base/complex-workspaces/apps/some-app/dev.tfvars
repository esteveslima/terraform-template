# Assignment file for development environment using terraform workspaces
# Beware not to commit this file with sensible data(consider using it on .gitignore)

# Select workspace with "terraform workspace select dev" before using this file with '... -var-file dev.tfvars' flag in a terraform command
